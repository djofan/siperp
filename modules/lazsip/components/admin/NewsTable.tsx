          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[720px] text-left text-sm">
              ...
              <tbody className="divide-y divide-lazsip-primary-50">
                {filtered.map((item) => (
                  <tr key={item.id} className="transition-colors hover:bg-lazsip-primary-50/40">
                    ...
                    <td className="max-w-xs truncate px-4 py-3.5 font-medium text-lazsip-primary-900">{item.title}</td>
                    <td className="px-4 py-3.5">
                      <button
                        type="button"
                        ...
                        className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-bold transition-colors disabled:cursor-not-allowed disabled:opacity-50 ${
                          item.status === "published" ? "bg-lazsip-secondary-50 text-lazsip-secondary-700" : "bg-lazsip-primary-900/5 text-lazsip-primary-900/50"
                        }`}
                      >

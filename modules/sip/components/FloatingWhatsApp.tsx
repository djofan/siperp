export function FloatingWhatsApp() {
  const number = process.env.NEXT_PUBLIC_SIP_WHATSAPP;
  if (!number) return null;

  const message = encodeURIComponent("Assalamu'alaikum, saya ingin mengajukan bantuan / bertanya seputar SIP.");
  ...
  return (
    <a
      ...
      aria-label="Hubungi CS SIP via WhatsApp"

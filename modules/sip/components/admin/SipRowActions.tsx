    ...
    <div className="flex items-center justify-end gap-1.5">
      {onEdit && (
        <button
          ...
          disabled={deleting}
          aria-label="Edit"
          className="flex h-8 w-8 items-center justify-center rounded-lg text-sip-primary-700 transition-colors hover:bg-sip-primary-50 disabled:cursor-not-allowed disabled:opacity-50"
        >
